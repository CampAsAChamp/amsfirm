...
[![My Skills](https://skills.syvixor.com/api/icons?perline=9&i=nextjs,reactjs,typescript,tailwindcss,cloudflare,nodejs,yarn,vitest,playwright,framer,lucide,resend,prettier,eslint,commitlint,git,github)](https://builder.syvixor.com/)
