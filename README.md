...
[![My Skills](https://skills.syvixor.com/api/icons?perline=10&i=nextjs,reactjs,typescript,tailwindcss,postcss,cloudflare,nodejs,vite,vitest,playwright,eslint,commitlint,framer,lucide,resend,prettier,dependabot,git,github)](https://builder.syvixor.com/)
