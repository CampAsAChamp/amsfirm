...
export const icons = {
  ...
  checkmark: (
    <svg className="w-8 h-8 text-amber-950" fill="currentColor" viewBox="0 0 20 20">
...
export const services = [
  {
    ...
    description: "Create legally binding documents that ensure your assets are distributed according to your wishes and your family is protected.",
    features: [
  ...
  },
  {
    ...
    description: "Establish trusts to protect your assets, minimize taxes, and provide for your loved ones with professional trust administration.",
    features: [
